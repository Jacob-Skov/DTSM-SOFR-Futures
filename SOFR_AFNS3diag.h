...
class SOFR_AFNS3diag : public Problem<double>
{
public:

	SOFR_AFNS3diag(const MatrixXd& Data, const double& dt1, const double& dt2) :
		...
		else
		{
			...
			for (size_t i = 0; i < Data.rows(); i += 12)
			{
				...
				do
				{
					...
					MatrixXd rates_1m = fut_price_1m(quotes_1m, dt2, Sigma(0, 0), Sigma(0, 1), Sigma(0, 2), Sigma(1, 0), Sigma(1, 1), Sigma(1, 2), Sigma(2, 0), Sigma(2, 1), Sigma(2, 2), Lambda, xPost2);

					B_1m = rates_1m.rightCols(3);


					VectorXd rates_3m = fut_price_3m(quotes_3m, dt2, Sigma(0, 0), Sigma(0, 1), Sigma(0, 2), Sigma(1, 0), Sigma(1, 1), Sigma(1, 2), Sigma(2, 0), Sigma(2, 1), Sigma(2, 2), Lambda, xPost2);

					VectorXd B1_3m = (fut_price_3m(quotes_3m, dt2, Sigma(0, 0), Sigma(0, 1), Sigma(0, 2), Sigma(1, 0), Sigma(1, 1), Sigma(1, 2), Sigma(2, 0), Sigma(2, 1), Sigma(2, 2), Lambda, xPost2 + Vector3d(dx, 0.0, 0.0)) - rates_3m) / dx;
					VectorXd B2_3m = (fut_price_3m(quotes_3m, dt2, Sigma(0, 0), Sigma(0, 1), Sigma(0, 2), Sigma(1, 0), Sigma(1, 1), Sigma(1, 2), Sigma(2, 0), Sigma(2, 1), Sigma(2, 2), Lambda, xPost2 + Vector3d(0.0, dx, 0.0)) - rates_3m) / dx;
					VectorXd B3_3m = (fut_price_3m(quotes_3m, dt2, Sigma(0, 0), Sigma(0, 1), Sigma(0, 2), Sigma(1, 0), Sigma(1, 1), Sigma(1, 2), Sigma(2, 0), Sigma(2, 1), Sigma(2, 2), Lambda, xPost2 + Vector3d(0.0, 0.0, dx)) - rates_3m) / dx;

					B_3m << B1_3m, B2_3m, B3_3m;

					B << B_1m, B_3m;

					rates << rates_1m.col(0), rates_3m;
				...
				//VectorXd rates_1 = fut_price_1m(quotes_1m, dt2, Sigma(0, 0), Sigma(0, 1), Sigma(0, 2), Sigma(1, 0), Sigma(1, 1), Sigma(1, 2), Sigma(2, 0), Sigma(2, 1), Sigma(2, 2), Lambda, xPost1).leftCols(1);

				//VectorXd rates_3 = fut_price_3m(quotes_3m, dt2, Sigma(0, 0), Sigma(0, 1), Sigma(0, 2), Sigma(1, 0), Sigma(1, 1), Sigma(1, 2), Sigma(2, 0), Sigma(2, 1), Sigma(2, 2), Lambda, xPost1);
